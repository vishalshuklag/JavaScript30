...
//   let newInventors = inventors.filter( inventor => {
//     if ( inventor.year > 1500 && inventor.year < 1600) {
//         return true;
//     }
//   })
  let newInventors = inventors.filter( inventor => ( inventor.year > 1500 && inventor.year < 1600))
...
//   console.table(ordered)
  ...
  const totalYearLived = inventors.reduce( (total, inventor) => {
      return total + (inventor.passed - inventor.year);
  }, 0)
//   console.log(totalYearLived)

  // 5. Sort the inventors by years lived
  const yearsLived = inventors.sort( (firstPerson, secondPerson) => {
    const prevPerson = firstPerson.passed - firstPerson.year;
